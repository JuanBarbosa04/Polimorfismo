...
public class NaveHalconMilenario extends Naves{
    ...
    public NaveHalconMilenario() {
    }

    public NaveHalconMilenario(int cantPersonas, int cantLitrosPorParsec, int cantNaves) {
